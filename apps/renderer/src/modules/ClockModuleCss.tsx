...
/**
 * Lightweight CSS / DOM clock with digit fall animation. Wrapped externally by
 * ClockModule.tsx, which applies the rotation / mirror transforms.
 */
export function ClockModuleCss({ config }: Props) {
